...
const SetBack = () => {
    ...
    const [hoursback, setHoursback] = React.useState(0)
        ...
        <section id="app-container">
            ...
            <div id='timepicker'>
                ...
                <Container sx={{ width: 700 }} id='container'>
                    ...
                    <span className="directions-content">Find Your Phase Delay Schedule</span>
                            ...
                            <Box sx={{ padding: '20px', borderRadius: '5ch', maxWidth: 500, bgcolor: 'background.paper' }}>
                                <List>
                                    ...
                                    >
                                        ...
                                        <ListItemText primary={`${moment(LTM, 'hh:mm A').subtract(4, 'hours').format('hh:mm A')} - ${LTM}`} />
                                    </ListItem>
                                    <ListItem disablePadding>
                                        <ListItemIcon>
                                            <LightModeIcon />
                                    ...
                                    <ListItem disablePadding>
                                        ...
                                        <ListItemText primary={hoursback > 1 ? "Exercise" : "Exercise (optional)"} />
                                    </ListItem>
                                    <ListItem disablePadding>
                                        <ListItemIcon>
                                            <BreakfastDiningIcon />
                                        </ListItemIcon>
                                        <ListItemText primary={hoursback > 1 ? "Eat a Snack" : "Eat a Snack (optional)"} />
                                    </ListItem>
                                    {
                                        hoursback == 3 ?
                                            <ListItem disablePadding>
                                    ...
                                    >
                                        ...
                                        <ListItemText primary={`Try to avoid engaging in the above between ${LTM} and ${moment(LTM, 'hh:mm A').add(4, 'hours').format('hh:mm A')} `} />
                                    </ListItem>
                                    <ListItem disablePadding>
                                        <ListItemIcon>
                                            <ComputerIcon />
